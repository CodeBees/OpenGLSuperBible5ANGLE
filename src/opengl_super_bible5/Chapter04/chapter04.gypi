  ...
  'conditions': [
    ['OS=="win"', {
      'targets': [
        ...
        {
          'target_name': 'chapter04_sphereworld3',
          'type': 'executable',
          'dependencies': [
            '<(DEPTH)/third_party/esGLUT/esGLUT.gyp:esGLUT',
            'gltools',
          ...
          'sources': [
            'SphereWorld3/SphereWorld3.cpp',
          ],
        },
        {
          'target_name': 'chapter04_sphereworld4',
          'type': 'executable',
          'dependencies': [
            '<(DEPTH)/third_party/esGLUT/esGLUT.gyp:esGLUT',
            'gltools',
